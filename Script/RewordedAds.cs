...
public class RewordedAds : MonoBehaviour

{
    [SerializeField] private UlManagerCanvas uimanagercanvas;
#if UNITY_ANDROID
    ...
    public void ShowRewardedAd()
    {
        ...
        if (_rewardedAd != null && _rewardedAd.CanShowAd())
        {
            _rewardedAd.Show((Reward reward) =>
            {
                ...
                CoinCalculator(400);
                uimanagercanvas.StartCoroutine("AfterRewordButton");
                //UlManagerCanvas.instance.NextScane();
